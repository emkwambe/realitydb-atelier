        ...
        <div className="flex flex-col gap-8 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <div className="mt-6 grid grid-cols-2 gap-4 md:grid-cols-4">
              <Stat label="Assets" value="$12B" />
              <Stat label="Customers" value="280K" />
              <Stat label="Branches" value="42" />
              <Stat label="Wire vol / mo" value="$180M" />
            </div>
          </div>
          ...
          <div className="md:max-w-sm">
            ...
            <p className="mt-3 text-sm leading-relaxed text-[#e2e8f0]/80">
              FinCEN examination in 60 days. Internal audit flagged three
              accounts with unusual wire patterns. Determine whether it&apos;s
              structuring, layering, or a false positive before the examiner
              arrives.
            </p>

            <div className="mt-4 flex items-center gap-2 font-mono text-[11px] text-[#64748b]">
              <Database className="size-3.5" />
              11 tables · 50,000 rows · PostgreSQL
            </div>

            <Link
              href="/companies/clearbank/exercise/1"
      ...
      <section className="mt-10">
        <div className="flex items-baseline justify-between">
          ...
          <span className="font-mono text-xs text-[#64748b]">
            {clearbankExercises.length} exercises · SAR recommendation memo
          </span>
        </div>

...
const CERT_KEY = "atelier:clearbank:cert";
    ...
    return (
      <div className="mx-auto max-w-2xl px-6 py-20 text-center">
        ...
        <p className="mt-2 text-sm text-[#64748b]">
          Submit a SAR recommendation memo to see your score and certificate.
        </p>
        <Link
          href="/companies/clearbank/briefing"

...
const CERT_KEY = "atelier:medcore:cert";
  ...
  useEffect(() => {
    ...
    (async () => {
      const c: BizCertificate = {
        ...
        company: medcoreRubric.company,
        companyLabel: medcoreRubric.companyLabel,
  ...
  if (!result) {
    return (
      <div className="mx-auto max-w-2xl px-6 py-20 text-center">
        ...
        <Link
          href="/companies/medcore/briefing"
          ...
          <table className="data-grid w-full font-mono text-[13px]">
            ...
            <tbody>
              {(
                ...
                const def = medcoreRubric.axes[key];

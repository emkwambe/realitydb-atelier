...
const STORAGE_KEY = "atelier:medcore:briefing";
const RESULT_KEY = "atelier:medcore:result";
const DATASET_KEY = "atelier:medcore:dataset";
const VISITED_KEY = "atelier:medcore:visitedScenarios";
...
export default function MedCoreBriefingPage() {
  ...
  async function submit() {
    ...
    try {
      ...
      router.push("/companies/medcore/results");
    } catch (e) {
            ...
            <div>
              ...
              {rubricOpen && (
                <ul className="mt-2 space-y-2 text-[11px] leading-relaxed text-[#64748b]">
                  {Object.values(medcoreRubric.axes).map((axis) => (
                    <li key={axis.name}>
                  ...
                  <li className="pt-2 text-[#06d6a0]">
                    Passing score: {medcoreRubric.passingScore}/100
                  </li>
                </ul>
              )}
            </div>
        ...
        <div className="mx-auto max-w-3xl px-6 py-10">
          <header>
            <div className="font-mono text-xs uppercase tracking-wider text-[#64748b]">
              MedCore Health · Module 02
            </div>
            <h1 className="mt-2 text-3xl font-medium text-[#e2e8f0]">
              CEO Briefing — MedCore Revenue Cycle
            </h1>

...
const RESULT_KEY = "atelier:towernet:result";
const CERT_KEY = "atelier:towernet:cert";
...
export default function ResultsPage() {
  ...
  useEffect(() => {
    ...
    (async () => {
      const c: BizCertificate = {
        ...
        company: towernetRubric.company,
        companyLabel: towernetRubric.companyLabel,
  ...
  if (!result) {
    return (
      <div className="mx-auto max-w-2xl px-6 py-20 text-center">
        ...
        <Link
          href="/companies/towernet/briefing"
  ...
  return (
    <div className="mx-auto max-w-4xl px-6 py-12">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <div className="font-mono text-xs uppercase tracking-wider text-[#64748b]">
              CEO Briefing · TowerNet Communications
            </div>
          ...
          <table className="data-grid w-full font-mono text-[13px]">
            ...
            <tbody>
              {(["segmentation","causal_reasoning","quantification","recommendation","epistemic_honesty"] as const).map((key) => {
                ...
                const def = towernetRubric.axes[key];
      ...
      <section className="mt-8">
        <h2 className="text-sm font-medium uppercase tracking-wider text-[#64748b]">Briefing feedback</h2>

...
const STORAGE_KEY = "atelier:towernet:briefing";
const RESULT_KEY = "atelier:towernet:result";
const DATASET_KEY = "atelier:towernet:dataset";
const VISITED_KEY = "atelier:towernet:visitedScenarios";
...
export default function TowerNetBriefingPage() {
  ...
  async function submit() {
    ...
    try {
      ...
      router.push("/companies/towernet/results");
    } catch (e) {
            ...
            <div>
              ...
              {rubricOpen && (
                <ul className="mt-2 space-y-2 text-[11px] leading-relaxed text-[#64748b]">
                  {Object.values(towernetRubric.axes).map((axis) => (
                    <li key={axis.name}>
                  ...
                  <li className="pt-2 text-[#06d6a0]">
                    Passing score: {towernetRubric.passingScore}/100
                  </li>
                </ul>
              )}
            </div>
        ...
        <div className="mx-auto max-w-3xl px-6 py-10">
          <header>
            <div className="font-mono text-xs uppercase tracking-wider text-[#64748b]">
              TowerNet Communications · Module 04
            </div>
            <h1 className="mt-2 text-3xl font-medium text-[#e2e8f0]">
              CEO Briefing — TowerNet Investor Call
            </h1>

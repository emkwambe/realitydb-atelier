...
const CERT_KEY = "atelier:novapay:cert";
  ...
  if (!result) {
    return (
      <div className="mx-auto max-w-2xl px-6 py-20 text-center">
        ...
        <Link
          href="/companies/novapay/briefing"
    ...
    <div className="mx-auto max-w-4xl px-6 py-12">
      ...
      {!result.passed && (
        <section className="mt-8 border border-[#ef4444]/30 bg-[#ef4444]/5 p-6">
          ...
          <p className="mt-2 text-sm text-[#64748b]">
            Review these chapters at{" "}
            <a
              href="https://sandbox.realitydb.dev"
              className="text-[#06d6a0] hover:underline"
            >
              sandbox.realitydb.dev
            </a>
            .
          </p>
        </section>

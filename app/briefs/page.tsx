...
export const metadata: Metadata = {
  title: "Weekly Briefs · RealityDb Atelier",
  description:
    "30-minute auto-graded business briefs published weekly. Free forever. Live PostgreSQL in your browser.",
};
  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-16">
      ...
      <h1 className="mt-5 text-3xl font-medium text-[#e2e8f0] md:text-5xl">
        ...
        <br />
        <span className="text-[#00f5d4]">A free 30-minute brief every Monday.</span>
      </h1>
      ...
      <div className="mt-10 grid grid-cols-1 gap-6 md:grid-cols-3">
        <div className="border-l-2 border-[#00f5d4] pl-4">
          ...
          <p className="mt-2 text-sm text-[#e2e8f0]/80">
            A new brief lands at 8am ET. Synthesised by RealityDb. Always free.
          </p>
        </div>
        <div className="border-l-2 border-[#06d6a0] pl-4">
          ...
          <p className="mt-2 text-sm text-[#e2e8f0]/80">
            Read-in, two exercises, a four-bullet briefing. Sized for a Sunday
            evening or a Monday lunch break.
          </p>
        </div>
      ...
      <p className="mt-12 text-center text-sm text-[#64748b]">
        Want to be notified when Brief 001 publishes?
      </p>
      <div className="mt-4 flex justify-center gap-3">
        <Link
          href="/auth/signup?source=briefs"
